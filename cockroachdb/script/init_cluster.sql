...
W_TAX DECIMAL(4,4),
W_YTD DECIMAL(12,2),
PRIMARY KEY(W_ID)) CSV DATA ('nodelocal://1/project-files/data-files/warehouse.csv');
...
D_YTD DECIMAL(12,2),
D_NEXT_O_ID INT,
PRIMARY KEY(D_W_ID, D_ID)) CSV DATA ('nodelocal://1/project-files/data-files/district.csv');
...
C_DELIVERY_CNT INT,
C_DATA VARCHAR(500),
PRIMARY KEY(C_W_ID, C_D_ID, C_ID)) CSV DATA ('nodelocal://1/project-files/data-files/customer.csv');
...
O_ENTRY_D TIMESTAMP,
PRIMARY KEY(O_W_ID, O_D_ID, O_ID)) CSV DATA ('nodelocal://1/project-files/data-files/order.csv') WITH nullif = 'null';
...
I_IM_ID INT,
I_DATA VARCHAR(50),
PRIMARY KEY(I_ID)) CSV DATA ('nodelocal://1/project-files/data-files/item.csv');
...
PRIMARY KEY(OL_W_ID, OL_D_ID, OL_O_ID, OL_NUMBER)) CSV DATA ('nodelocal://1/project-files/data-files/order-line.csv') WITH nullif = 'null';
...
S_DIST_10 CHAR(24),
S_DATA VARCHAR(50),
PRIMARY KEY(S_W_ID, S_I_ID)) CSV DATA ('nodelocal://1/project-files/data-files/stock.csv');
