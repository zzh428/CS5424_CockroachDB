...
FAMILY O_O (O_W_ID, O_D_ID, O_ID, O_C_ID, O_OL_CNT, O_ALL_LOCAL, O_ENTRY_D),
FAMILY O_CA (O_CARRIER_ID)
...
FAMILY OL_O (OL_W_ID, OL_D_ID, OL_O_ID, OL_NUMBER, OL_I_ID, OL_AMOUNT, OL_SUPPLY_W_ID, OL_QUANTITY, OL_DIST_INFO),
FAMILY OL_D (OL_DELIVERY_D)
